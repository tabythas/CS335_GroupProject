public class data {
    ...
    private String[] header_17th = {"The Supper at Emmaus (1601) is a Baroque painting by...", "This prayer book shows the Virgin Mary. It is from the country...", "The Night Watch (1642) is a painting by...", 
                        "Vermeer's painting Girl with a Pearl Earring is an example of...", "Vermeer's Baroque painting (1657) is called..."};
    ...
    private String[] summaryField_17th = {"Need to add description here",
                                            "Need to add summary here",
                                            "Need to add summary here",
                                            "Need to add summary here",
                                            "Need to add summary here"};
    ...
    private String[] header_18th = {"The Blue Boy (1770) by Thomas Gainsborough is an example of...", "The Lake of Albano and Castel Gandolfo (1783) is a landscape painting that depicts a lake in...", "Marie Antoinette and Her Children (1787) is an oil painting by...", 
                        "The Defeat of the Floating Batteries at Gibraltar, September 1782 (1791) is a painting by...", "Watson and the Shark (1778) is an oil painting by John Singleton Copley. The painting is an example of..."};
    ...
    private String[] summaryField_18th = {"Need to add description here",
                                            "Need to add summary here",
                                            "Need to add summary here",
                                            "Need to add summary here",
                                            "Need to add summary here"};
    ...
    private String[] header_19th = {"This impressionist painting (1875-1876) is by Edgar Degas and is called...", "The Balloon (1886) is a painting by French artist...", "Theodore Gericault painted this horrifying scene of cannibalism, which is called...", 
                        "The Gleaners is an oil painting (1857) by...", "Bridge over a Pond of Water Lilies (1899) is a oil painting by..."};
    ...
    private String[] summaryField_19th = {"Need to add description here",
                                            "Need to add summary here",
                                            "Need to add summary here",
                                            "Need to add summary here",
                                            "Need to add summary here"};
    ...
    private String[] summaryField_20th = {"Need to add description here",
                                            "Need to add summary here",
                                            "Need to add summary here",
                                            "Need to add summary here",
                                            "Need to add summary here"};
    ...
    public String[] getSummaryArray17() {
        return summaryField_17th.clone();
    }
    ...
    public String[] getSummaryArray18() {
        return summaryField_18th.clone();
    }
    ...
    public String[] getSummaryArray19() {
        return summaryField_19th.clone();
    }
    ...
    public String[] getSummaryArray20() {
        return summaryField_20th.clone();
    }
